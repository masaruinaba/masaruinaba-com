...
export function createOpening() {
  ...
  root.className='opening';root.setAttribute('aria-label','SAYDAY — Little voices. Big memories.');
  root.innerHTML=`<div class="opening-paper"></div>
    <div class="opening-character"><img alt="" draggable="false" fetchpriority="high"></div>
    <div class="opening-logo" role="img" aria-label="SAYDAY"><i class="opening-logo-base"></i></div>
    <p class="opening-description"></p><p class="opening-copy"></p>
    <div class="opening-footer"><p class="opening-title"></p><p class="opening-edition"></p></div>`;
  ...
  words(root.querySelector('.opening-description'),['Little voices.','Big memories.']);
  words(root.querySelector('.opening-copy'),['Keep the little things','they say, along with','photos from the day.']);
  words(root.querySelector('.opening-title'),['Today says hi.']);
